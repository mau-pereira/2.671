...
tag_size = 0.2 # in meters,based on actual tag size # TODO

### CALIBRATION SETUP ###
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
DATASET_FOLDER = os.path.join("calibration", "calibration_images_april21")
INTRINSICS_FILENAME = "calibration_intrinsics_april21.yaml"
fname = os.path.join(SCRIPT_DIR, DATASET_FOLDER, INTRINSICS_FILENAME)
